...
Clarifications:
  - step-1: the task matched several audit skills above the relative floor.
            Narrow the goal for a sharper selection.
...
- The audit step came back ambiguous: several audit skills cleared the bar for that goal. Tholo did not pick for the human and did not prepare a dispatch it was not confident in. The plan stopped at needs-clarification, with the step named and the narrowing suggested.
